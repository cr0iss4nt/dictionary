...
#    features = {case, number} - {'NONE'}
#    return inflect(noun, morph, features)



#def inflect_adjective(adjective, morph: pymorphy3.MorphAnalyzer(), case, gender):
#    features = {case, gender} - {'NONE'}
#    return inflect(adjective, morph, features)
